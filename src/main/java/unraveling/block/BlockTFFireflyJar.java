...
import unraveling.entity.EntityTFTinyFirefly;
...
public class BlockTFFireflyJar extends Block {
    ...
    {
    	return UnravelingMod.proxy.getComplexBlockRenderID();
    }
    ...
    {
        BlockTFFireflyJar.jarTop = par1IconRegister.registerIcon(UnravelingMod.ID + ":fireflyjar_top");
        BlockTFFireflyJar.jarSide = par1IconRegister.registerIcon(UnravelingMod.ID + ":fireflyjar_side");
        BlockTFFireflyJar.jarCork = par1IconRegister.registerIcon(UnravelingMod.ID + ":fireflyjar_cork");
    }
