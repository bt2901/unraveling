...
import unraveling.client.model.ModelTFProtectionBox;
import unraveling.entity.EntityTFProtectionBox;
...
public class RenderTFProtectionBox extends Render {
    ...
    private static final ResourceLocation textureLoc = new ResourceLocation(UnravelingMod.MODEL_DIR + "protectionbox.png");
