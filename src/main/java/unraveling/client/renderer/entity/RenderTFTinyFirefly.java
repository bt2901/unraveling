...
import unraveling.client.model.ModelTFTinyFirefly;
...
public class RenderTFTinyFirefly extends Render {
    ...
    private static final ResourceLocation textureLoc = new ResourceLocation(UnravelingMod.MODEL_DIR + "firefly-tiny.png");
